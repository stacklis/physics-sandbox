// app.js — main app: renderer, input, tools, presets, UI wiring (free edition)
// no telemetry — by design (see /privacy.html)
'use strict';

// ?embed=1 — landing-page iframe demo. Strip the topbar branding so the demo
// blends into the marketing hero. Runs before the IIFE so the body class is
// applied before any layout-dependent code.
try {
